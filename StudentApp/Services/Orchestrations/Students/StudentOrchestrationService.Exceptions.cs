...
namespace StudentApp.Services.Orchestrations.Students
{
    internal partial class StudentOrchestrationService
    {
        ...
        private async ValueTask<Student> TryCatch(ReturningStudentFunction returningStudentFunction)
        {
            ...
            catch (StudentOrchestrationDependencyValidationException)
            {
                throw;
            }
            catch (StudentOrchestrationDependencyException)
            {
                throw;
            }
            catch (StudentOrchestrationServiceException)
            {
                throw;
            }
            ...
            catch (LibraryCardDependencyException libraryCardDependencyException)
            {
                throw CreateAndLogDependencyException(libraryCardDependencyException);
            }
