...
namespace StudentApp.Tests.Unit.Services.Foundations.Students
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRetrieveByIdIfStudentIdIsInvalidAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRetrieveByIdIfStudentIsNotFoundAndLogItAsync()
        {
            // given
